import { displayCartItems, selectElementsForCart } from './newarrival_cart.js';
import { getLocalStorage, setLocalStorage } from './newarrival_script.js';
...
function displayData(data) {
  data.items.forEach((item, index) => {
    ...
    div.innerHTML = `
          ...
          <h4> PHP </h4><h5 class="product__1--price"> ${item.fields.price} </h5> 
